...
7-rag/README
```
This *Getting Started* section of the documentation is meant to help you get started with Theoria Guardrails. It is structured as a sequence of guides focused on specific topics. Each guide builds on the previous one by introducing new concepts and features. For each guide, in addition to the README, you will find a corresponding Jupyter notebook and the final configuration (*config.yml*) in the *config* folder.

1. [Hello World](./1-hello-world/README.md): get started with the basics of Theoria Guardrails by building a simple rail that controls the greeting behavior.
