...
This was a brief introduction to Colang 1.0. For more details, check out the [Examples folder](https://github.com/Theoria/NeMo-Guardrails/tree/develop/examples) document.
