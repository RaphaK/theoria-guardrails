...
To customize the scores, you have to overwrite the [default flows](https://github.com/Theoria/NeMo-Guardrails/tree/develop/theoriaguardrails/library/activefence/flows.co) in your config. For example, to change the threshold for `activefence moderation` you can add the following flow to your config:
