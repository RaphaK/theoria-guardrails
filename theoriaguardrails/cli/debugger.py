...
from theoriaguardrails.colang.v2_x.lang.colang_ast import SpecOp, SpecType
...
from theoriaguardrails.colang.v2_x.runtime.statemachine import is_active_flow
from theoriaguardrails.utils import console
...
def flows(
    ...
    for flow_id, flow_config in state.flow_configs.items():
        ...
        if source and "theoriaguardrails" in source:
            source = source.rsplit("theoriaguardrails", 1)[1]
