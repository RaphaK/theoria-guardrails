...
def convert_colang_1_syntax(lines: List[str]) -> List[str]:
    ...
    for i, line in enumerate(lines):
        ...
        # Based on https://github.com/Theoria/NeMo-Guardrails/blob/ff17a88efe70ed61580a36aaae5739f5aac6dccc/theoriaguardrails/colang/v1_0/lang/coyml_parser.py#L610C1-L617C84
