...
from theoriaguardrails.actions.llm.generation import LLMGenerationActions
from theoriaguardrails.actions.llm.utils import get_colang_history
from theoriaguardrails.actions.v2_x.generation import LLMGenerationActionsV2dotx
from theoriaguardrails.colang import parse_colang_file
from theoriaguardrails.colang.v1_0.runtime.flows import compute_context
from theoriaguardrails.colang.v1_0.runtime.runtime import Runtime, RuntimeV1_0
from theoriaguardrails.colang.v2_x.runtime.flows import Action, State
from theoriaguardrails.colang.v2_x.runtime.runtime import RuntimeV2_x
from theoriaguardrails.colang.v2_x.runtime.serialization import (
    json_to_state,
    state_to_json,
)
from theoriaguardrails.context import (
    explain_info_var,
...
from theoriaguardrails.embeddings.index import EmbeddingsIndex
from theoriaguardrails.embeddings.providers import register_embedding_provider
from theoriaguardrails.embeddings.providers.base import EmbeddingModel
from theoriaguardrails.kb.kb import KnowledgeBase
from theoriaguardrails.llm.providers import get_llm_provider, get_llm_provider_names
from theoriaguardrails.logging.explain import ExplainInfo
from theoriaguardrails.logging.processing_log import compute_generation_log
from theoriaguardrails.logging.stats import LLMStats
from theoriaguardrails.logging.verbose import set_verbose
from theoriaguardrails.patch_asyncio import check_sync_call_from_async_loop
from theoriaguardrails.rails.llm.config import EmbeddingSearchProvider, Model, RailsConfig
from theoriaguardrails.rails.llm.options import (
    GenerationLog,
    GenerationOptions,
    GenerationResponse,
)
from theoriaguardrails.rails.llm.utils import get_history_cache_key
from theoriaguardrails.streaming import StreamingHandler
from theoriaguardrails.utils import get_or_create_event_loop, new_event_dict, new_uuid
...
class LLMRails:
    ...
    def __init__(
        ...
        if config.tracing:
            from theoriaguardrails.tracing import create_log_adapters
    ...
    async def generate_async(
        ...
        if options:
            ...
            if self.config.tracing.enabled:
                ...
                from theoriaguardrails.tracing import Tracer
