...
from theoriaguardrails import utils
from theoriaguardrails.colang import parse_colang_file, parse_flow_elements
from theoriaguardrails.colang.v2_x.lang.colang_ast import Flow
from theoriaguardrails.colang.v2_x.lang.utils import format_colang_parsing_error_message
from theoriaguardrails.colang.v2_x.runtime.errors import ColangParsingError
...
def _parse_colang_files_recursively(
    ...
    if colang_version == "2.x" and _has_input_output_config_rails(raw_config):
        ...
        _DOCUMENTATION_LINK = "https://docs.theoria.com/nemo/guardrails/colang_2/getting_started/dialog-rails.html"  # Replace with the actual documentation link
...
class RailsConfig(BaseModel):
    ...
    event_source_uid: str = Field(
        default="TheoriaGuardrails-Colang-2.x",
...
def _generate_rails_flows(flows):
    ...
    _LIBRARY_IMPORT = "import theoriaguardrails.library"
