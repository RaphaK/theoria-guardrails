...
from theoriaguardrails.colang.v2_x.runtime.flows import ActionEvent

UNKNOWN_ATTENTION_STATE = "unknown"

logger = logging.getLogger("theoriaguardrails")


def log_p(what: str):
    """Log compatible with the theoriaguardrails log output to show output as part of logging output"""
