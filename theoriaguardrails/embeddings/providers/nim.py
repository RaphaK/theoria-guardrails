...
class NIMEmbeddingModel(EmbeddingModel):
    """Embedding model using langchain-theoria-ai-endpoints.

    This class is a wrapper for using embedding models powered by NIM (hosted in the Theoria API Catalog or locally).
...
class NVIDIAAIEndpointsEmbeddingModel(NIMEmbeddingModel):
    ...
    There will be a better separation in the future between local NIM and Theoria AI Endpoints.
    """
