...
from theoriaguardrails.evaluate.evaluate_factcheck import FactCheckEvaluation
from theoriaguardrails.evaluate.evaluate_hallucination import HallucinationRailsEvaluation
from theoriaguardrails.evaluate.evaluate_moderation import ModerationRailsEvaluation
from theoriaguardrails.evaluate.evaluate_topical import TopicalRailsEvaluation
...
def moderation(
    ...
    dataset_path: str = typer.Option(
        "theoriaguardrails/evaluate/data/moderation/harmful.txt",
    ...
    Args:
        ...
        dataset_path (str): Path to the dataset containing prompts.
            Defaults to "theoriaguardrails/evaluate/data/moderation/harmful.txt".
...
def hallucination(
    ...
    dataset_path: str = typer.Option(
        "theoriaguardrails/evaluate/data/hallucination/sample.txt", help="Dataset path"
    ),
    num_samples: int = typer.Option(50, help="Number of samples to evaluate"),
    output_dir: str = typer.Option(
    ...
    Args:
        config (str): The path to the guardrails config. Defaults to "config".
        dataset_path (str): Dataset path. Defaults to "theoriaguardrails/evaluate/data/hallucination/sample.txt".
        num_samples (int): Number of samples to evaluate. Defaults to 50.
...
def fact_checking(
    ...
    dataset_path: str = typer.Option(
        "theoriaguardrails/evaluate/data/factchecking/sample.json",
    ...
    Args:
        config (str): The path to the guardrails config. Defaults to "config".
        dataset_path (str): Path to the folder containing the dataset. Defaults to "theoriaguardrails/evaluate/data/factchecking/sample.json".
