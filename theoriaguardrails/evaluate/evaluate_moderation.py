...
from theoriaguardrails.evaluate.utils import load_dataset
from theoriaguardrails.llm.params import llm_params
from theoriaguardrails.llm.prompts import Task
...
class ModerationRailsEvaluation:
    ...
    def __init__(
        self,
        config: str,
        dataset_path: str = "theoriaguardrails/theoriaguardrails/evaluate/data/moderation/harmful.txt",
        num_samples: int = 50,
