...
class TheoriaLLM(BaseLLM):
    ...
    api_host: Optional[str] = os.environ.get(
        "NGC_API_HOST", "https://api.llm.ngc.theoria.com"
    )
    ...
    def _default_params(self) -> Dict[str, Any]:
        """Get the default parameters for calling TheoriaLLM API."""
        return {
    ...
    async def _acall(
        ...
        **kwargs,
        ...
        """Call out to TheoriaLLM completion endpoint.
