...
def co_v2(
    ...
    bot say "Greetings! I am the official Theoria Benefits Ambassador AI bot and I'm here to assist you."
...
def user_assistant_sequence_theoriallm(events: List[dict]) -> str:
    """Filter that turns an array of events into a sequence of user/assistant messages.
...
def to_messages_theoriallm(colang_history: str) -> str:
