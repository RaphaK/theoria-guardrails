...
from theoriaguardrails.llm.filters import (
    co_v2,
    colang,
    ...
    to_messages,
    to_messages_theoriallm,
    to_messages_v2,
    user_assistant_sequence,
    user_assistant_sequence_theoriallm,
    verbose_v1,
)
from theoriaguardrails.llm.output_parsers import (
    bot_intent_parser,
    bot_message_parser,
    is_content_safe,
    user_intent_parser,
...
from theoriaguardrails.rails.llm.config import MessageTemplate, RailsConfig
...
class LLMTaskManager:
    ...
    def __init__(self, config: RailsConfig):
        ...
        self.env.filters["to_messages_theoriallm"] = to_messages_theoriallm
